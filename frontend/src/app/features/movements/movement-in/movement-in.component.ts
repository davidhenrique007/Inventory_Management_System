    ...
    <div class="movement-container">
      <mat-card>
        <mat-card-header>
          ...
          <mat-card-subtitle>Registrar entrada de produtos no estoque</mat-card-subtitle>
        </mat-card-header>
        ...
        <mat-card-content>
          ...
          <form [formGroup]="entryForm" (ngSubmit)="onSubmit()" *ngIf="product">
            <div class="form-row">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <textarea
                ...
                rows="2"
                placeholder="Ex: Compra de fornecedor, Nota fiscal..."
              ></textarea>
            </mat-form-field>
            ...
            <div class="form-actions">
              ...
              >
                ...
                <span *ngIf="!saving">Registrar Entrada</span>
              </button>
            </div>
          </form>
        </mat-card-content>
...
export class MovementInComponent {
  ...
  onSubmit(): void {
    if (!this.product || this.entryForm.invalid) return;
    ...
    this.movementService.createEntry(data).subscribe({
      next: () => {
        this.snackBar.open('Entrada registrada com sucesso!', 'Fechar', { duration: 3000 });
        this.router.navigate(['/movements']);
      },
      error: (error) => {
        const message = error.error?.message || 'Erro ao registrar entrada';
